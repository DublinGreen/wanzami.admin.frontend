...
export const SOFT_DELETE_PROFILE_BY_ID = gql`
mutation SoftDeleteProfileById ($id: Int!) {
  softDeleteProfileById(id: $id) {
      id
      status
      name
      avatar
...
export const SOFT_ACTIVATE_PROFILE_BY_ID = gql`
mutation SetActiveProfileById ($id: Int!) {
    setActiveProfileById(id: $id) {
        id
        status
        name
        avatar
